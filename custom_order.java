...
public class custom_order {
    ...
    // STEP 4 DISPLAY MENU
		...
		System.out.println("	MENU		QAUNTITY		BASE COST		");
		System.out.println("____________________________________________________");
		System.out.println("	Cake		1				R15			");
		System.out.println("Set of Cupcakes		6				R15			");
		System.out.println("----------------------------------------------------");
    ...
    // STEP 6 PROMPT USER TO CHOOSE FROSTING
		...
		System.out.println("Vanilla, Chocolate, Strwberry, or Coco");
    ...
    // STEP 9 DISPLAY ORDER CONFIRMATION
		...
		System.out.println("____________________________________________________");
		System.out.println("Ordered item: " + itemOrder);
    ...
    // STEP 10 DISPLAY COST AND SALES TAX
		...
		System.out.printf("The cost of you order is: R%.2f\n", cost);
		tax = cost * TAX_RATE;
		System.out.printf("The tax is: R%.2f\n", tax);
		System.out.printf("The total due is: R%.2f\n", tax + cost);
